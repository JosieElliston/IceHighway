...
public class IceHighwayBuilder extends Module {
    ...
    private final Integer HEIGHT = 3;
    ...
    private BlockPosProvider blockPosProvider;
    ...
    public void onActivate() {
        ...
        blockPosProvider = new BlockPosProvider();
    ...
    private int getWidthLeft() {
        // TODO #1 option to change which side the ice is placed on
        return 0;
    ...
    private enum State {
        Center {
            @Override
            protected void tick(IceHighwayBuilder b) {
        ...
        Forward {
            ...
            private boolean needsToMine(IceHighwayBuilder b, MBPIterator it, boolean ignoreBlocksToPlace) {
                for (MBlockPos pos : it) {
            ...
            private boolean needsToPlace(IceHighwayBuilder b, MBPIterator it, boolean liquids) {
                for (MBlockPos pos : it) {
        ...
        ThrowOutTrash {
            ...
            @Override
            protected void start(IceHighwayBuilder b) {
                int biggestCount = 0;
        ...
        protected abstract void tick(IceHighwayBuilder b);

        protected void mine(IceHighwayBuilder b, MBPIterator it, boolean ignoreBlocksToPlace, State nextState, State lastState) {
        ...
        protected void mine(IceHighwayBuilder b, MBPIterator it, boolean ignoreBlocksToPlace) {
            mine(b, it, ignoreBlocksToPlace, Forward, b.state);
        }

        protected void place(IceHighwayBuilder b, MBPIterator it, int slot, State nextState) {
        ...
        private int findSlot(IceHighwayBuilder b, Predicate<ItemStack> predicate, boolean hotbar) {
        ...
        private int findHotbarSlot(IceHighwayBuilder b, boolean replaceTools) {
            int thrashSlot = -1;
        ...
        // private boolean hasItem(IceHighwayBuilder b, Item item) {
        //     for (int i = 0; i < b.mc.player.getInventory().main.size(); i++) {
        ...
        protected int findAndMoveToHotbar(IceHighwayBuilder b, Predicate<ItemStack> predicate, boolean required) {
            // Check hotbar
        ...
        protected int findAndMoveBestToolToHotbar(IceHighwayBuilder b, BlockState blockState, boolean noSilkTouch, boolean error) {
            // Check for creative
        ...
        protected int findBlocksToPlace(IceHighwayBuilder b) {
        ...
        protected int findBlocksToPlacePrioritizeTrash(IceHighwayBuilder b) {
    ...
    private class BlockPosProvider {
...
// // public class IceHighwayModule extends Module {
// //     // public enum Mode {
// //     //     HighwayBuilding,
// //     //     AxisDigging,
// //     //     NegNegDigging,
...
// //     public IceHighway() {
// //         super(IceHighway.CATEGORY, "ice-highway", "makes a ice highway");
// //     }
...
//         super(IceHighway.CATEGORY, "IceHighway", "Automatically builds highways.");
//     }
...
//         // blockPosProvider = new StraightBlockPosProvider();
